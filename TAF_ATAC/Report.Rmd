...
Note that for all models we assume a Gaussian distribution of the errors. For some time-series that depart from normality 
...
- the truncated trend (without AR) shown as a light yellow plain line.\
