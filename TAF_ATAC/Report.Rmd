...
tags: [WGINOR, ICES, time-series, 2023]
...
5. a new "truncated" model is fitted to the time-series up to 2020. This model has the same form (ie., same AR process) as the best model fitted on the whole time series. \n
6. the truncated model is used to make forecasts for 2021, 2022 and 2023. \
